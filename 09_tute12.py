...
def getvals():
    ...
    print(f"{nameValue.get(), phoneValue.get(), genderValue.get(), emergencyContectValue.get(), paymentModeValue.get(), foodServiceValue.get()}")

    with open('records.txt', 'a') as f:
        f.write(f"{nameValue.get(), phoneValue.get(), genderValue.get(), emergencyContectValue.get(), paymentModeValue.get(), foodServiceValue.get()}\n")
